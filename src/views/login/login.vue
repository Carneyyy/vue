        ...
        <div class="fr form-box">
          ...
          <form id="jsLoginForm" autocomplete="off">
            ...
            <div class="form-group marb8">
              <label>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</label>
              <input name="password_l" id="password_l" type="password" placeholder="请输入您的密码" v-model="passWord" @focus="errorUnshow">
            </div>
             <p class="error-text" v-show="passwordError">{{passwordError}}</p>
  ...
  methods: {
    login () {
      ...
      login({
        ...
        // console.log('12345678908766')
      }).catch(error => {
        if ('non_field_errors' in error) {
          this.usernameError = error.non_field_errors[0]
        }
