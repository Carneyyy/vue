  ...
  <div>
            ...
            <div class="bd">
              <div class="tempWrap" style="overflow:hidden; position:relative; width:330px">
                <ul class="cle"
                  ...
                  <!-- 小图列表项 -->
                  <li @click="replaceShow(index,item)" v-for="(item,index) in  proDetail.images" :key="index" :class="{'current' : index === 'current'}">
                    <a>
        ...
        <div class="item-info" id="item-info">
          <dl class="loaded">
            <dt class="product_name">
              ...
              <p class="desc">
                <span
                  class="gray">{{proDetail.goods_brief}}</span>
              </p>
            </dt>
            <dd class="property">
              <ul>
                ...
                <li>
                  ...
                  class="nala_price red" id="ECS_SHOPPRICE">￥{{proDetail.shop_price}}元</strong> </span> <span class="timedown"
                                                                                         id="timedown"></span>
                </li>
                <li>
            ...
            <dd class="tobuy-box cle">
              <ul class="sku">
                <li class="skunum_li cle">
                  ...
                  <div class="skunum"><span class="minus" title="减少1个数量" @click="resuceNum"><i class="iconfont">-</i></span>
                    <input id="number" name="number" type="text" min="1" readonly v-model="buyNum">
                    <span class="add" title="增加1个数量"><i class="iconfont" @click="addNum">+</i></span> <cite class="storage"> 件 </cite>
                  </div>
                  <div class="skunum">
                    <!--库存-->
                ...
                <li class="add_cart_li">
                  <a class="btn" id="buy_btn" @click="addShopCart">
                    <i class="iconfont">&#xe600;</i>加入购物车
                  </a>
                  <a id="fav-btn" class="graybtn" v-if="this.hasFav" @click="deleteCollect">
                    <i class="iconfont">&#xe613;</i>已收藏
                  </a>
                  <a class="graybtn" v-else @click="addCollect">
    ...
    <div class="detail_bgcolor">
      <div class="z-detail-box cle">
        ...
        <hostSales @no-hot="hotChange"></hostSales>
      </div>
    </div>
...
import hostSales from './hostSales'
import model from './model'
import {getGoodsDetail, getFav, addFav, delFav, getShopCarts} from '../../api/api'
